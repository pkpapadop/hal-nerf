...
def config_parser():
    ...
    parser.add_argument("--expname", type=str, default='certh_train_val_45_rot_0.1_trans_dm', help='experiment name')
    parser.add_argument("--basedir", type=str, default='logs', help='where to store ckpts and logs')
    parser.add_argument("--datadir", type=str, default='/home/asterisreppas/dfnet_data_final', help='input data directory')
    ...
    parser.add_argument("--random_view_synthesis", action='store_true', default=True,  help='add random view synthesis')
    parser.add_argument("--rvs_refresh_rate", type=int, default=5, help='re-synthesis new views per X epochs')
    parser.add_argument("--rvs_trans", type=float, default=0.1, help='jitter range for rvs on translation')
    parser.add_argument("--rvs_rotation", type=float, default=45, help='jitter range for rvs on rotation, this is in log_10 uniform range, log(15) = 1.2')
    ...
    parser.add_argument("--feature_matching_lvl", nargs='+', type=int, default=[2], 
                        help='lvl of features used for feature matching, default use lvl 0, 1, 2')
    parser.add_argument("--per_channel", default=True, action='store_true', help='using per channel cosine similarity loss instead of per pixel, defualt False')
    ...
    parser.add_argument("--tripletloss", action='store_true', default=True, help='use triplet loss at training featurenet, this is to prevent catastophic failing')
