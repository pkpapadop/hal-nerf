...
from nerfacto_loader_2 import load_model
from nerfacto_loader_2 import get_params
...
def train_feature(args, train_dl, val_dl, test_dl, hwf, i_split, nerfacto_model, nerfacto_params):
    ...
    early_stopping = EarlyStopping(args, patience=args.patience[0], verbose=False, delta=0.00001)
    ...
    # Convert the numpy array to a PyTorch tensor
                    ...
                    virtue_view.append(rendered_tensor)
